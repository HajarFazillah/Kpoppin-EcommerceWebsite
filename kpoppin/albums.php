...
<div class="row">
	<div class="left">
		...
		<ul id="myMenu" style="width:250px">
			<li><a href="http://localhost/kpoppin/blackpink.php">BLACKPINK</a></li>
			<li><a href="http://localhost/kpoppin/bts.php">BTS</a></li>
			<li><a href="http://localhost/kpoppin/mamamoo.php">MAMAMOO</a></li>
			<li><a href="http://localhost/kpoppin/nct.php">NCT</a></li>
			<li><a href="http://localhost/kpoppin/exo.php">EXO</a></li>
			<li><a href="http://localhost/kpoppin/redvelvet.php">Red Velvet</a></li>
			<li><a href="http://localhost/kpoppin/suju.php">Super Junior</a></li>
			<li><a href="http://localhost/kpoppin/2ne1.php">2NE1</a></li>
			<li><a href="http://localhost/kpoppin/everglow.php">Everglow</a></li>
		</ul>
	</div>
	...
	<?php
	$product_array5 = $db_handle5->runQuery("SELECT * FROM album ORDER BY id ASC");
	if (!empty($product_array5)) { 
		foreach($product_array5 as $key=>$value){
	?>
		<div class="product-item" style="height:350px;width:250px" >
			<form method="post" action="cart.php?action=add&code=<?php echo $product_array5[$key]["code"]; ?>" >
			<div class="product-image" style="height:210px;">
				<center>
				<img src="<?php echo $product_array5[$key]["image"]; ?>" style="height:200px;width:199px;padding-left:20px"></center>
			</div>
			<div class="product-tile-footer">
			<div class="product-title"><?php echo $product_array5[$key]["name"]; ?></div>
			<div class="product-price"><?php echo "$".$product_array5[$key]["price"]; ?></div>
