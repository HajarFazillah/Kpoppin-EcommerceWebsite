...
<div class="row">
	...
	<?php
	$product_array = $db_handle->runQuery("SELECT * FROM blackpink ORDER BY id ASC");
	...
	?>
		<div class="product-item" style="height:350px;width:250px">
			...
			<div class="product-image" style="height:220px">
				<center>
				<img src="<?php echo $product_array[$key]["image"]; ?>" style="height:200px;width:199px;padding-left:20px"></center>
