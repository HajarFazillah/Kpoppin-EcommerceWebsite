...
<div class="row">
	...
	<?php
	$product_array4 = $db_handle4->runQuery("SELECT * FROM exo ORDER BY id ASC");
	if (!empty($product_array4)) { 
		foreach($product_array4 as $key=>$value){
	?>
		<div class="product-item" style="height:350px;width:250px" >
			<form method="post" action="cart.php?action=add&code=<?php echo $product_array4[$key]["code"]; ?>" >
			<div class="product-image" style="height:210px;">
				<center>
				<img src="<?php echo $product_array4[$key]["image"]; ?>" style="height:200px;width:199px;padding-left:20px"></center>
			
			</div>
			<div class="product-tile-footer">
			<div class="product-title"><?php echo $product_array4[$key]["name"]; ?></div>
			<div class="product-price"><?php echo "$".$product_array4[$key]["price"]; ?></div>
