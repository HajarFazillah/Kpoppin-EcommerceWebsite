...
<div class="row">
	...
	<?php
	$product_array3 = $db_handle3->runQuery("SELECT * FROM nct ORDER BY id ASC");
	if (!empty($product_array3)) { 
		foreach($product_array3 as $key=>$value){
	?>
		<div class="product-item" style="height:350px;width:250px" >
			<form method="post" action="cart.php?action=add&code=<?php echo $product_array3[$key]["code"]; ?>" >
			<div class="product-image" style="height:210px;">
				<center>
				<img src="<?php echo $product_array3[$key]["image"]; ?>" style="height:200px;width:199px;padding-left:20px"></center>
			
			</div>
			<div class="product-tile-footer">
			<div class="product-title"><?php echo $product_array3[$key]["name"]; ?></div>
