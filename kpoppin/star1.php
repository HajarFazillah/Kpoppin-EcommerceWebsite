...
<html>
	<head>
		<title>Kpoppin: Photocards and Posters</title>
		<meta charset="UTF-8">
	...
	<?php
	$product_array6 = $db_handle6->runQuery("SELECT * FROM star1 ORDER BY id ASC");
	if (!empty($product_array6)) { 
		foreach($product_array6 as $key=>$value){
	?>
		<div class="product-item" style="height:350px;width:250px" >
			<form method="post" action="cart.php?action=add&code=<?php echo $product_array6[$key]["code"]; ?>" >
			<div class="product-image" style="height:210px;">
				<center>
				<img src="<?php echo $product_array6[$key]["image"]; ?>" style="height:200px;width:199px;padding-left:20px"></center>
			
			</div>
			<div class="product-tile-footer">
			<div class="product-title"><?php echo $product_array6[$key]["name"]; ?></div>
			<div class="product-price"><?php echo "$".$product_array6[$key]["price"]; ?></div>
